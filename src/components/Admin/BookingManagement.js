...
import { Table, Badge, Button, Spinner, InputGroup, FormControl, Pagination, Modal, Form, Row, Col } from "react-bootstrap";
...
const API_URL = "https://localhost:7176/api/admin/AdminBooking";
        ...
        <div className={styles.container}>
                    ...
                    <Table hover responsive className="align-middle mb-0">
                        ...
                        <tbody>
                            {currentData.length > 0 ? (
                                    ...
                                    <tr key={b.bookingId}>
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center gap-2">
                                                ...
                                                <span className="fw-medium">{b.diner?.fullName || "Khách vãng lai"}</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div className="d-flex align-items-center gap-2">
                                        ...
                                        <td>
                                            <div className="text-muted small">
                                                <FaCalendarAlt className="me-1" /> {new Date(b.bookingTime).toLocaleString('vi-VN')}
                                            </div>
                                        </td>
                                ...
                                <tr><td colSpan="7" className="text-center py-5 text-muted">Không tìm thấy dữ liệu.</td></tr>
                            )}
                        </tbody>
                    </Table>
                )}
            ...
            <Modal show={showModal} onHide={() => setShowModal(false)} centered>
                ...
                <Modal.Footer>
                    ...
                    <Button variant="primary" onClick={handleSaveEdit}><FaSave className="me-2" />Lưu thay đổi</Button>
                </Modal.Footer>
            </Modal>
        </div>
    );
